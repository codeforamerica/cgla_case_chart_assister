  ...
  describe 'basic_case_chart_hash' do
    it 'returns a hash of the basic case chart information for the given index' do
      event = CglaCaseChartAssister::Charge.new(
        ...
        offense_class: '4',
        dispositions: [
          CglaCaseChartAssister::Disposition.new(description: 'Not Guilty', date: '10-Oct-2005', sentence_description: 'No Sentence')
        ]
      )
  ...
  describe 'pre_jano_case_chart_hash' do
    it 'returns a hash of some basic and eligibility case chart information for the given index' do
      event = CglaCaseChartAssister::Charge.new(
        ...
        offense_class: nil,
        dispositions: [
          CglaCaseChartAssister::Disposition.new(description: 'Pre-JANO Disposition', date: '10-Oct-2005', sentence_description: 'Pre-JANO Sentence')
        ]
      )
    ...
    context 'when pending_case is false' do
      ...
      it 'returns a hash of eligibility case chart information for the given disposition type and index' do
        dismissal = CglaCaseChartAssister::Charge.new(
          ...
          offense_class: '4',
          dispositions: [
              CglaCaseChartAssister::Disposition.new(description: 'Dismissed', date: '10-Oct-2005', sentence_description: 'No Sentence')
          ]
        )
    ...
    context 'when pending_case is false' do
      ...
      it 'returns the csv hash with eligibility information populated for the given disposition type' do
        ...
        event = CglaCaseChartAssister::Charge.new(
          ...
          offense_class: '4',
          dispositions: [
              CglaCaseChartAssister::Disposition.new(description: 'Guilty', date: '10-Oct-2005', sentence_description: 'Jail(10)')
          ]
        )
    ...
    context 'when pending_case is true' do
      ...
      it 'returns the csv hash with eligibility set to false for the given disposition type' do
        ...
        event = CglaCaseChartAssister::Charge.new(
          ...
          offense_class: '4',
          dispositions: [
              CglaCaseChartAssister::Disposition.new(description: 'Dismissed', date: '10-Oct-2005', sentence_description: 'Jail(10)')
          ]
        )
